...
from pytrinamic.modules import TMCM1110  # noqa: E402
...
class MockTmclInterface:
    ...
    def get_axis_parameter(self, type, axis, module_id, signed, ap_index_bit_width):
        if type == TMCM1110._MotorTypeA.AP.PositionReachedFlag:
            self._position_reached_toggle ^= True
...
@pytest.mark.parametrize('example_script_path', [
    f'../TMCM1110/TMCL/CoolStep_demo.py',
    f'../TMCM1110/TMCL/rotate_demo.py',
    f'../TMCM1110/TMCL/StallGuard2_demo.py',
])
